...
set_clock_uncertainty -setup 0.15   [get_pins u_ITF.u_CLK.u_CLKREL_SysClk/clk_out]
set_clock_uncertainty -hold  0.1    [get_pins u_ITF.u_CLK.u_CLKREL_SysClk/clk_out]

set_clock_uncertainty -setup 0.15   [get_pins u_ITF.u_CLK.u_CLKREL_OffClk/clk_out]
