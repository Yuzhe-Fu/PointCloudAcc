...
set_input_delay  -clock clock_clk -clock_fall -add_delay [expr 0.0*$period_clk] [all_inputs]
set_output_delay -clock clock_clk -clock_fall -add_delay [expr 0.2*$period_clk] [all_outputs]
...
# set_input_transition -min 0.05 [filter_collection [all_inputs] "full_name !~$clk && full_name !~I_SysRst_n "]
# set_input_transition -max 0.5  [filter_collection [all_inputs] "full_name !~$clk && full_name !~I_SysRst_n "]
